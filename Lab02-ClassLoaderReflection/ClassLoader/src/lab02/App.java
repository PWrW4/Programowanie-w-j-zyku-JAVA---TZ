...
public class App {
    ...
    public void loadUpper() {
        ...
        try {
            URL[] classLoaderUrls = new URL[]{new URL("file:/C:\\Workspace\\programowanie-w-jezyku-java-tz\\Lab02-ClassLoaderReflection\\TextProcesing\\out\\production\\TextProcesing/")};
    ...
    public void loadExla() throws NoSuchMethodException, ClassNotFoundException {
        try {
            URL[] classLoaderUrls = new URL[]{new URL("file:/C:\\Workspace\\programowanie-w-jezyku-java-tz\\Lab02-ClassLoaderReflection\\TextProcesing\\out\\production\\TextProcesing/")};
            URLClassLoader classloader2 = new URLClassLoader(classLoaderUrls);
            Class<?> class2 = classloader2.loadClass("Exclamation");
